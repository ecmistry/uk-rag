# Metric Tooltips Backup

> **Source file:** `client/src/data/metricTooltips.ts`
>
> **Last backed up:** 2026-03-17
>
> This is a reference backup of all dashboard metric tooltip text. If the source file is ever lost or corrupted, this document can be used to restore the content.
